...
class ProductRepositoryImpl implements ProductRepository {
  ...
  @override
  Future<List<Product>> getProducts({int page = 1, int limit = 10, Map<String, dynamic>? filters}) async {
    final response = await _api.getProducts(page: page, limit: limit, filters: filters);
    return _extractProducts(response);
  }
  ...
  Future<List<Product>> getProductsByCategory(String slug) async {
    final response = await _api.getProductsByCategory(slug);
    return _extractProducts(response);
  }
